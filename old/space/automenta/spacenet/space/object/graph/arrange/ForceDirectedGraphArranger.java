...
//    }
    ...
    public void forward(double dt) {
        ...
        for (E l : linkVis.keySet()) {
            ...
            double naturalLength = getLengthFactor().d() * (aRad / 2.0 + bRad / 2.0) / 2.0;
        ...
        for (V n : nodeVis.keySet()) {
            ...
            Box nBox = getBox(n);
            double nMass = nBox.getSize().getMaxRadius();
            ...
            for (V m : nodeVis.keySet()) {
                ...
                double mMass = mBox.getSize().getMaxRadius();
